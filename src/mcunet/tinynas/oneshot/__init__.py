...
def crossover(p1: Model, p2: Model) -> tuple[Model, Model]:
    ...
    o1 = _combine(p1.width_mult, p1_top, p2_bottom, p1.last_channels)
    o2 = _combine(p2.width_mult, p2_top, p1_bottom, p2.last_channels)
...
def mutation(
    ...
    return Model(model.width_mult, blocks, model.last_channels)
