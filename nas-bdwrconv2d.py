...
from mcunet.tinynas.instances import LastLayerSharer
from mcunet.tinynas.instances.bdwrconv2d import (
    mutator,
    choice_block_constructor,
    BDWRConv2dSearchSpace
)
...
def _common(
    ...
    space = BDWRConv2dSearchSpace(args.width_mult, args.resolution)
    ...
    if state is None:
        ...
        manager = SearchManager.from_dict(
            state, BDWRConv2dSearchSpace, ds, ds, supernet, logger
        )
